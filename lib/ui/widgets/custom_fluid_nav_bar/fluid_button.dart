...
class _FluidNavBarButtonState extends State<FluidNavBarButton>
  ...
  _FluidNavBarButtonState(MenuIconData iconData, bool selected,
      FluidNavBarButtonPressedCallback onPressed)
      : _iconData = iconData,
        _selected = selected,
        _onPressed = onPressed;
      ...
      child: Container(
          ...
          child: Container(
            ...
            child: Transform.scale(
              ...
              scale: scaleY,
              child: _selected ? _iconData.activeIcon : _iconData.icon,
            ),
          )),
    );
  }
