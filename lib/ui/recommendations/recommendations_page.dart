...
import 'package:sport_news/ui/widgets/custom_fluid_nav_bar/fluid_nav_bar.dart';
  ...
  Widget build(BuildContext c) {
    ...
    return Scaffold(
        body: BlocBuilder<RecommendationsBloc, RecommendationsState>(
            cubit: BlocProvider.of<RecommendationsBloc>(context)
    ...
    return SliverList(
      delegate: SliverChildListDelegate([
        ...
        state.newsIsEmpty && !state.isLoading
            ...
            : Container(),
        SizedBox(
          height: FluidNavBar.nominalHeight + 20,
        )
      ]),
    );
  }
